              ...
              {THEMES.map((t) => {
                ...
                return (
                  <button
                    ...
                    className={clsx(
                      "inline-flex items-center gap-1.5 h-7 px-3 rounded-[7px] text-[13px] font-medium tracking-[-0.005em] transition-colors",
                      active
  ...
  return (
    <div className="flex flex-col items-start gap-3 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
      <div className="min-w-0">
        <div className="text-[14px] font-medium text-ink tracking-[-0.005em]">{title}</div>
        <div className="text-[13px] text-muted mt-0.5 leading-snug">{hint}</div>
      </div>
      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={clsx(
              "inline-flex items-center justify-center h-7 px-3 rounded-[7px] text-[13px] font-medium tracking-[-0.005em] transition-colors",
              active
                ? "bg-surface text-ink shadow-[var(--shadow-sm)]"
                : "text-muted hover:text-ink",
            )}
...
function PaletteIcon({ swatch }: { swatch: PaletteSwatch }) {
  return (
    <span
      aria-hidden
      className="grid place-items-center w-[22px] h-[22px] rounded-md text-[12px] font-semibold shrink-0 border border-[rgba(0,0,0,0.06)]"
  ...
  return (
    <>
      <button
        ...
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center gap-2 h-8 pl-1.5 pr-2 rounded-[8px] border border-line-soft bg-surface hover:bg-surface-soft/60 transition-colors text-[13.5px] font-medium text-ink-soft"
      >
...
function PaletteRow({
  ...
  return (
    ...
    >
      ...
      <span className="text-[13.5px] text-ink flex-1">{palette.label}</span>
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-0.5">
        ...
        <div className="text-[12.5px] text-faint leading-snug">{variant.hint}</div>
      </div>
    </button>
  );
}
...
function Preview({
  ...
  return (
    ...
    >
      <span className="text-[12.5px] text-faint flex-1">Ask anything…</span>
      <span
        data-send="true"
