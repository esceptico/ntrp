---
title: "Memory"
description: "Admin APIs for memory scopes, records, lenses, search, and graph views."
---
...
- **Memory items** are source-backed records stored in a scope.
...
curl -X POST http://localhost:6877/admin/memory/record \
  ...
  -d '{"text":"User prefers concise engineering feedback.","scope":"default"}'
```
