...
const UserMessage = memo(function UserMessage({ id }: { id: string }) {
  ...
  return (
    ...
    >
      ...
      {showBubble && (
        <div className="glass-surface glass-radius-lg max-w-[75%] px-3.5 py-2 rounded-[18px] text-ink text-base leading-[1.45] whitespace-pre-wrap break-words text-left">
          {visibleText}
        </div>
      )}
