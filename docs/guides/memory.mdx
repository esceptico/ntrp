...
Fact extraction from conversations is also a builtin automation. It fires every 10 user messages or after 5 minutes of idle time, extracting durable facts from the conversation without running a full agent loop.
