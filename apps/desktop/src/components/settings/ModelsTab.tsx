...
export function ModelsTab() {
  ...
  if (!cfg) {
    ...
    return <div className="text-[13.5px] text-faint">Loading models…</div>;
  }
  ...
  return (
    <div className="grid gap-5">
      <div className="rounded-[10px] border border-line-soft bg-surface-soft/45 px-3.5 py-3 text-[13px] leading-[1.45] text-muted">
  ...
  return (
    <div className="grid gap-2.5 py-3">
      <div className="grid gap-0.5">
        ...
        <div className="text-[12.5px] text-faint leading-[1.4]">{description}</div>
      </div>
