...
2026-05-01: learning review scan proposes skill-note review candidates from explicit skill-scoped correction/failure events with direct evidence ids; it never writes skill files.
