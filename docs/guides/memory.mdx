...
Profile changes and continual-learning proposals stay review-gated. The system can propose them, but applying them still requires an explicit reviewed action; they are not silently promoted into always-on memory.
...
![Memory lenses view](../images/memory-learning.png)
