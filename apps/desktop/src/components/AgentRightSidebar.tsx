  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="glass-surface glass-frosted glass-radius-md absolute top-2 right-2 z-40 flex w-[256px] max-h-[calc(100vh-var(--chat-bottom-h,96px)-24px)] flex-col overflow-hidden rounded-xl"
      >
