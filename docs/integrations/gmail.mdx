...
Start the server and the desktop client. On first use of any email tool, ntrp will open a browser window for OAuth consent. The token is saved to `~/.ntrp/gmail_token.json`.
