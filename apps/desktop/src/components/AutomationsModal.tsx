...
function TabButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={clsx(
        "relative inline-flex items-center gap-1.5 h-9 text-[13px] font-medium tracking-[-0.005em] transition-colors",
    ...
    >
      ...
      {count != null && count > 0 && (
        <span
          className={clsx(
            "inline-flex items-center justify-center min-w-[20px] h-[18px] px-1.5 rounded-full text-[10.5px] font-medium tabular-nums",
  ...
  if (automations.length === 0) {
    return (
      <div className="grid gap-2 max-w-[420px] py-10">
        <div className="text-[14px] font-medium text-ink">No automations yet.</div>
        ...
        <div className="flex items-center gap-2 mt-1">
          <button
            ...
            className="inline-flex items-center h-8 px-3 rounded-md border border-line-soft text-[12.5px] font-medium text-ink-soft hover:bg-surface-soft hover:border-line-strong transition-colors"
          >
            Browse templates
          </button>
          <button
            type="button"
            onClick={onCreate}
            className="inline-flex items-center h-8 px-3 rounded-md text-[12.5px] font-medium text-muted hover:text-ink transition-colors"
          >
            Start from scratch
          </button>
        </div>
