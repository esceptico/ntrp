...
ntrp gives you an AI assistant that actually remembers. It connects to your email, calendar, web, MCP tools, and long-term memory — building a persistent knowledge graph that grows over time.
...
- **Keeps context lean** by loading infrequent tool schemas on demand
