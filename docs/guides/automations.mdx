...
![Automations viewer](../internal/images/automations.png)
...
Open the Automations view to inspect user automations, builtin automations, trigger state, and recent runs. Builtin automations like extraction and consolidation appear separately from user-created tasks.

Create or modify automations from chat, from the API, or through desktop surfaces as they become available. You can add multiple triggers to a single automation.
